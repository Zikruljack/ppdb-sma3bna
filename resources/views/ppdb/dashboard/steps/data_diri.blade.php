                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="agama" id="agama" class="form-control select2">
                                <option value="">Pilih</option>
                                <option value="islam" {{ old('agama', $ppdbUser->agama) == 'islam' ? 'selected' : '' }}>
                                    Islam
                                </option>
                                ...
                                <option value="hindu" {{ old('agama', $ppdbUser->agama) == 'hindu' ? 'selected' : '' }}>
                                    Hindu
                                </option>
                                <option value="budha" {{ old('agama', $ppdbUser->agama) == 'budha' ? 'selected' : '' }}>
                                    Budha
                                </option>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="npsn_asal_sekolah" name="npsn_asal_sekolah"
